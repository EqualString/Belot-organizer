                    ...
                    <ul class="slimmenu" id="slimmenu">
                        ...
                        <li class="active"><a>Turniri</a>
                            <ul>
                                ...
                                <li class="active"><a href="tournaments-underway">Nadolazeći</a></li>
            ...
            <div class="search-tabs search-tabs-bg search-tabs-to-top">
                <div class="tabbable">
                    <ul class="nav nav-tabs" id="myTab">
                        <li class="active"><a href="#tab-1" data-toggle="tab"><i class="icon icon-clipboard"></i> <span >Nadolazeći turniri</span></a>
                        </li>
                    </ul>
                    <div class="tab-content">
						<!-- Prijavljeni turniri -->
                        <div class="tab-pane fade in active" id="tab-1">
                            <h2>Turniri koji će se održavati</h2>

								<?php
									/** Završeni prijavljeni turniri **/
									
									$sql = "SELECT * FROM `Tournaments` WHERE started='0' AND finished='0' ORDER BY date"; 
									$q = mysqli_query($db_conx, $sql);
									$row_cnt = mysqli_num_rows($q);
									
									$br = 1;
									
									if ($row_cnt == 0){ echo '<h4>Nema turnira koji će se održavati.</h4>';}
